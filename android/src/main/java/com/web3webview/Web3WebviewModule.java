...
@ReactModule(name = Web3WebviewModule.MODULE_NAME)
public class Web3WebviewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public Web3WebviewModule(ReactApplicationContext reactContext) {
        super(reactContext);
